...
ENV NV_NVML_DEV_VERSION=12.8.90-1=> [instantmesh 10/20] RUN apt-get update &&     apt-get install -y --no-install-recommend  22671.3s
=> => # Ign:84 https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2204/x86_64  libnvvm-s
=> => # amples-12-1 12.1.105-1
=> => # Ign:85 https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2204/x86_64  cuda-tool
=> => # kit-12-1 12.1.1-1
=> => # Get:75 https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2204/x86_64  nsight-co
=> => # mpute-2023.1.1 2023.1.1.4-1 [703 MB] 下载太慢
